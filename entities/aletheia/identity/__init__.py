...
# Import submodules
from .validator import check_identity_completeness, validate_identity_file
...
class ModulePaths:
    ...
    memory_dir: str
    utility_model_gguf: str | None = None
...
class Identity:
    ...
    def _load_identity(self) -> None:
        ...
        try:
            ...
            msg = f"Identity file not found: {self.identity_path}"
            raise FileNotFoundError(msg)
        except json.JSONDecodeError as e:
            msg = f"Invalid JSON in identity file: {e}"
            raise ValueError(msg)

    def get_system_prompt(self, language: str | None = None, for_user_response: bool = False) -> str:
    ...
    def get_external_system_prompt(self, language: str | None = None) -> str:
    ...
    def get_user_facing_text(self, key: str, language: str | None = None, **kwargs) -> str:
    ...
    def get_fallback_response(self, language: str | None = None) -> str:
