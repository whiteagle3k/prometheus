...
class UserDataExtractor(ExtractorProcessor):
    ...
    def extract(self, text: str, context: dict[str, Any] | None = None) -> list[UserDataPoint]:
...
class EntityExtractor(ExtractorProcessor):
    ...
    def extract(self, text: str, context: dict[str, Any] | None = None) -> list[str]:
    ...
    def extract(self, text: str, context: dict[str, Any] | None = None) -> list[str]:
        ...
        for entity in entities:
            ...
            if entity_lower in self.priority_words:
                ...
                for category_words in self.topic_categories.values():
