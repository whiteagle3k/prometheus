...
from .registry import get_agent, get_running_agents, shutdown_all_agents
...
class LifecycleManager:
    ...
    async def startup(self, entities: list[str] | None = None) -> bool:
        """
    ...
    async def create_system_snapshot(self) -> dict[str, str]:
        ...
        for entity_name in running_agents:
            try:
                ...
                snapshots[entity_name] = f"ERROR: {e!s}"
...
async def startup_system(entities: list[str] | None = None) -> bool:
